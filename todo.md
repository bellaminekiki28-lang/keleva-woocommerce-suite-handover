...
- [ ] Finaliser toutes les chaînes AR restantes réellement visibles côté client, notamment les libellés WCFM encore non localisés et tout reliquat éditorial non graphique dans le DOM.
- [ ] Documenter séparément les limites non traduisibles, notamment le texte incrusté dans l’image hero, et ne déclarer la configuration FR/AR complète qu’après fermeture des reliquats HTML/UI.
- [ ] Rejouer une vraie recette navigateur du portail RTL sur desktop et mobile après authentification Keleva, avec preuves visuelles et fonctionnelles des écrans produits, catégories, options, variantes, commandes et déconnexion.
- [ ] Corriger et déployer le rendu navigateur du portail après connexion : imposer des en-têtes anti-cache spécifiques à `/espace-marchand/` et vérifier que la page suivante affiche réellement le dashboard, pas seulement un message de succès.
