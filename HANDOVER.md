...
| Addons | Version source `0.6.16` | Version `0.6.16` installée sur le staging Hostinger |
| Thème et RTL | CSS RTL conditionnel, WOFF2 Noto Sans Arabic auto-hébergés | Thème `0.4.19` validé sur `/ar/`, fiche variable et portail `/ar/espace-marchand/` |
