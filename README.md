...
La source de l’extension `Keleva Woo Addons` est en version **0.6.15** et le thème Keleva Woo en version **0.4.14**. Ces releases comprennent le portail de variantes stockées, le retrait des anciens raccourcis externes, la fondation i18n/RTL, l’auto-hébergement de Noto Sans Arabic et le correctif des onglets mobiles RTL de la fiche variable. Les détails de recette et de reprise sont dans [HANDOVER.md](HANDOVER.md), [la note i18n/RTL staging](wordpress-package/docs/I18N_RTL_STAGING_2026-08-26.md) et [la validation TranslatePress Free](wordpress-package/docs/FREE_TRANSLATION_STAGING_2026-08-26.md).

La fondation française-arabe utilise **TranslatePress Free** comme moteur unique : elle traduit le rendu d’un produit WooCommerce canonique au lieu de dupliquer produits, variantes, prix, stocks ou médias. Une première chaîne arabe de recette est validée ; les contenus catalogue restent majoritairement français tant qu’ils ne sont pas traduits manuellement dans l’éditeur. Gardez Polylang désactivé, n’installez aucun second gestionnaire multilingue et ne créez pas de produit arabe séparé.
