...
final class Keleva_Native_Merchant_Portal {
    ...
    private static function render_document_start(?array $session): void {
        ...
        echo '<!doctype html><html lang="fr"><head><meta charset="' . esc_attr(get_bloginfo('charset')) . '"><meta name="viewport" content="width=device-width,initial-scale=1"><title>' . esc_html($title) . '</title><style>' . self::styles() . '</style></head><body><main class="kp-shell">';
    }
