...
function keleva_woo_palettes(): array {
    return [
        ...
        'azur' => [
            ...
            'bg' => '#F2F6FB', 'surface' => '#FEFEFF', 'surface_media' => '#D9E6F0',
        ...
        'obsidienne-cuivree' => [
            'label' => __('Obsidienne Cuivrée', 'keleva-woo'),
            'bg' => '#0D0D0F', 'surface' => '#16161A', 'surface_card' => '#16161A', 'surface_media' => '#211E22',
            'ink' => '#F2EDE4', 'muted' => '#B8ADA0', 'subtle' => '#9F958A', 'line' => '#2A282C',
            'accent' => '#9C5518', 'accent_strong' => '#7A430F', 'accent_text' => '#C97A3A', 'accent_deep' => '#713C10', 'on_accent' => '#F2EDE4', 'on_ink' => '#F2EDE4',
            'success' => '#4A7C6F', 'success_wash' => '#17312C', 'warning' => '#C9922E', 'warning_wash' => '#3A2B12',
            'danger' => '#B23A3A', 'danger_wash' => '#3B1718', 'media' => '#211E22', 'benefit' => '#1C1B1E',
            'shadow_tint' => '#000000',
        ],
        'ivoire-encre' => [
            'label' => __('Ivoire Encre', 'keleva-woo'),
            'bg' => '#F5F1E8', 'surface' => '#FFFFFF', 'surface_card' => '#FFFFFF', 'surface_media' => '#EEE8DC',
            'ink' => '#1A1613', 'muted' => '#6D6459', 'subtle' => '#766D64', 'line' => '#E0D9CC',
            'accent' => '#6B1E23', 'accent_strong' => '#4A1418', 'accent_deep' => '#3B0F13', 'on_accent' => '#F5F1E8', 'on_ink' => '#FFFFFF',
            'success' => '#3A6656', 'success_wash' => '#E3EFE9', 'warning' => '#8C6118', 'warning_wash' => '#FBF0D6',
            'danger' => '#8E2A2A', 'danger_wash' => '#FBE6E6', 'media' => '#EEE8DC', 'benefit' => '#ECE5D9',
            'shadow_tint' => '#1A1613',
        ],
        'argile-sombre' => [
            'label' => __('Argile Sombre', 'keleva-woo'),
            'bg' => '#1C1A17', 'surface' => '#26231F', 'surface_card' => '#26231F', 'surface_media' => '#312E27',
            'ink' => '#EDE7DC', 'muted' => '#A69B8C', 'subtle' => '#918678', 'line' => '#3A362F',
            'accent' => '#5D6A44', 'accent_strong' => '#454F32', 'accent_text' => '#8C9A6C', 'accent_deep' => '#414A2F', 'on_accent' => '#EDE7DC', 'on_ink' => '#EDE7DC',
            'success' => '#3E7A63', 'success_wash' => '#173429', 'warning' => '#B98A3E', 'warning_wash' => '#3B2D16',
            'danger' => '#A34635', 'danger_wash' => '#3C1B17', 'media' => '#312E27', 'benefit' => '#29261F',
            'shadow_tint' => '#0D0C0B',
        ],
        'perle-graphite' => [
            'label' => __('Perle Graphite', 'keleva-woo'),
            'bg' => '#F4F3F1', 'surface' => '#FFFFFF', 'surface_card' => '#FFFFFF', 'surface_media' => '#ECEAE7',
            'ink' => '#201E24', 'muted' => '#6A6670', 'subtle' => '#6E6A74', 'line' => '#DEDBD6',
            'accent' => '#4A2545', 'accent_strong' => '#331A30', 'accent_deep' => '#281325', 'on_accent' => '#F4F3F1', 'on_ink' => '#FFFFFF',
            'success' => '#2E6350', 'success_wash' => '#E2EFE9', 'warning' => '#7C611E', 'warning_wash' => '#F7EFD7',
            'danger' => '#8F3232', 'danger_wash' => '#FBE7E7', 'media' => '#ECEAE7', 'benefit' => '#E9E7E4',
            'shadow_tint' => '#201E24',
        ],
    ];
}
...
function keleva_woo_palette_css(): string {
    ...
    $variables = [
        ...
        '--accent' => $palette['accent'], '--accent-strong' => $palette['accent_strong'], '--accent-text' => $palette['accent_text'] ?? $palette['accent_strong'], '--accent-deep' => $palette['accent_deep'], '--on-accent' => $palette['on_accent'], '--on-ink' => $palette['on_ink'],
